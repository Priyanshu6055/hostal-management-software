...
<div class="container mt-5">
    ...
    <form id="buildingForm" novalidate> {{-- Added novalidate to prevent browser's default validation --}}
        ...
        <div class="mb-3">
            ...
            <div class="invalid-feedback" id="university_id_error"></div> {{-- Validation error display --}}
        </div>
        ...
        <div class="mb-3" hidden>
            ...
            <div class="invalid-feedback" id="created_by_error"></div> {{-- Validation error display --}}
        </div>
