...
<head>
    ...
    <style>
        ...
        .form-control.is-invalid + .invalid-feedback { /* Added for textarea specific error */
...
<script>
    ...
    /**
     * Clears the error message for a given form field.
     * @param {string} fieldName - The name of the form field.
     */
    function clearErrorMessage(fieldName) {
        ...
        if (errorDiv) {
            ...
            if (inputElements.length > 0) {
                ...
                const specificElement = document.getElementById(fieldName);
                if (specificElement) {
                    specificElement.classList.remove('is-invalid');
                }
            }
        }
    }
    ...
    /**
     * Checks the validity of the entire form and enables/disables the submit button.
     */
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        // Special handling for the agree checkbox
        ...
        if (showApprovalMessage) {
            ...
            setTimeout(() => {
                ...
                // Optionally, redirect to a different part of the guest area
                // window.location.href = "/guest/dashboard";
            }, 6000);
        } else {
            // Load accessories only if not showing the approval message
