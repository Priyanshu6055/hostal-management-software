<!-- REPLACED LINE WITH CLEAN HOSTEL FEE SUMMARY -->

<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <title>Guest Payment Details</title>
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    if (!guestId || isNaN(guestId)) {
        paymentDetailsEl.innerHTML = "<div class='alert alert-danger'>Invalid guest ID provided in the URL.</div>";
        return;
    }
    ...
    fetch(`/api/guest/${guestId}/total-amount`)
        ...
        .then(response => {
            ...
            return fetch('/api/accessories/active')
                .then(res => res.json())
