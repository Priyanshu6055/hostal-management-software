...
@php
    $resident = \App\Models\Resident::where('user_id', auth()->id())->with('user')->first();
@endphp
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const apiUrl = `/api/residents/${residentId}/leave-requests`;
...
@else
    <div class="alert alert-danger text-center mt-4">Resident not found.</div>
@endif
