    ...
    @if(auth()->check() && auth()->user()->hasRole('resident'))
        ...
        @if($resident)
            ...
            <script>
                ...
                const currentResidentId = {{ $resident->id }};
                ...
                function fetchGrievances() {
                    fetch(`/api/grievances/resident/${currentResidentId}`)
                ...
                function viewGrievance(grievanceId) {
                    ...
                    fetch(`/api/grievances/${grievanceId}`)
                        ...
                        .then(data => {
                            ...
                            initialMessageDiv.style.textAlign = 'left';
                            ...
                            grievance.responses.forEach(response => {
                                ...
                                const isFromCurrentResident = response.resident_id === currentResidentId;
                ...
                async function closeGrievance(grievanceId) {
                    ...
                    fetch(`/api/grievances/close/${grievanceId}`, {
                        method: 'PUT',
                        headers: {
                ...
                document.getElementById("chatForm").addEventListener("submit", function(event) {
                    ...
                    fetch(`/api/grievances/resident/respond/${currentGrievanceId}`, {
                        method: "POST",
                        headers: {
                            "Content-Type": "application/json",
                            "X-CSRF-TOKEN": "{{ csrf_token() }}"
        ...
        @else
            <div class="alert alert-warning">Resident record not found for this user.</div>
        @endif
    @else
        <div class="alert alert-danger">Unauthorized. Only residents can view this page.</div>
    @endif
</div>
@endsection
